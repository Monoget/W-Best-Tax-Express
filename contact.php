                    ...
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                <h5>Endicott Branch</h5>
                                <p>103 Washingtone Avenue 2nd Fl, Endicott, NY 13760</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                <h5>Buffalo Branch</h5>
                                <p>1288 Fillmore Avenue, Buffalo, NY 14211</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                ...
                                <p>159-06 Hillside Avenue, Jamaica, NY 11432</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                <h5>Woodside Branch</h5>
                                <p>69-07 Roosevelt Avenue 2nd Fl, Woodside, NY 11377</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
