                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-5">
                        <div class="footer-widget-box about-us">
                            ...
                            <p class="mb-4">
                                We provide comprehensive tax and financial services tailored to meet your needs,
                                ensuring a hassle-free experience with guaranteed quality and accuracy.
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <ul class="footer-social">
                        ...
                        <li><a href="https://www.twitter.com/besttaxexpress"><i class="fab fa-x-twitter twitter"></i></a></li>
